...
cap1: "Praying for a family near Prey Vihea"
pic2: /assets/images/2023-Nov/church-in-Anlong-Veng.jpg
cap2: "After church service sharing time in Anlong Veng"
pic3: /assets/images/2023-Nov/pray-over-new-land.jpg
cap3: "Praying over new land"
pic4: /assets/images/2023-Nov/take-a-ferry.jpg
cap4: "Taking a ferry crossing the river"
pic5: /assets/images/2023-Nov/welding-training-center.jpg
cap5: "Pray with missionary friends in a welding training centre in Siem Reap"
---
...
![{{ page.cap1 }}]({{ page.pic1 }}){:.glightbox} *{{ page.cap1 }}* 
{:.h-center}

![{{ page.cap2 }}]({{ page.pic2 }}){:.glightbox }*{{ page.cap2 }}*
{:.h-center}
...
![{{ page.cap3 }}]({{ page.pic3 }}){:.glightbox} *{{ page.cap3 }}* 
{:.h-center}

![{{ page.cap4 }}]({{ page.pic4 }}){:.glightbox} *{{ page.cap4 }}* 
{:.h-center}

![{{ page.cap5 }}]({{ page.pic5 }}){:.glightbox} *{{ page.cap5 }}* 
{:.h-center}
